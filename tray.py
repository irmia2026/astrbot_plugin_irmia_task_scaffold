...
def _build_menu(toggle_fn, open_fn, exit_fn):
    return pystray.Menu(
        pystray.MenuItem("切换 Plan/Build", toggle_fn),
        pystray.MenuItem("打开仪表板", open_fn),
        pystray.Menu.SEPARATOR,
        pystray.MenuItem("退出托盘", exit_fn),
    )
...
def start():
    ...
    def _loop():
        ...
        icon = pystray.Icon(
            ...
            _make_icon(_GRAY),
            "长任务 · 加载中",
            menu=_build_menu(toggle_mode, open_dashboard, on_exit),
        )
